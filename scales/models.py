...
class RPatientMedicalHistory(models.Model):
    ...
    accompanying_symptoms = models.CharField(max_length=30, blank=True, null=True)
    current_state = models.CharField(max_length=30, blank=True, null=True)
    is_comorbidity = models.IntegerField(blank=True, null=True)
    comorbidity_content = models.CharField(max_length=30, blank=True, null=True)
    ...
    previous_period_of_remission = models.IntegerField(blank=True, null=True)
    ...
    total_sick_time = models.IntegerField(blank=True, null=True)
    is_schooling_suspension = models.IntegerField(blank=True, null=True)
    suspension_month = models.IntegerField(blank=True, null=True)
    others = models.CharField(max_length=30, blank=True, null=True)
    is_impaired_relationships = models.IntegerField(blank=True, null=True)
    impaired_reason = models.CharField(max_length=50, blank=True, null=True)
    is_non_suicidal_self_harm = models.IntegerField(blank=True, null=True)
    non_suicidal_self_harm_num = models.IntegerField(blank=True, null=True)
    ...
    titration_start_time = models.DateField(blank=True, null=True)
    titration_end_time = models.DateField(blank=True, null=True)
    doctor = models.ForeignKey('users.Suser', models.DO_NOTHING)
    create_time = models.DateTimeField(auto_now_add=True)
    update_time = models.DateTimeField(auto_now=True)
